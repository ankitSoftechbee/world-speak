                ...
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    <TableHead className="bg-gray-100">
                        <TableRow>
                            ...
                            <TableCell align="right"><div className='text-lg font-bold'>Ref ID</div></TableCell>
                            <TableCell align="right"><div className='text-lg font-bold'>Ref ID</div></TableCell>
                            <TableCell align="right"><div className='text-lg font-bold'>Ref Name</div></TableCell>
                            <TableCell align="right"><div className='text-lg font-bold'>Status</div></TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {data && data.map((item, index) => (
                            ...
                            >
                                ...
                                <TableCell align="right">{item.reffid}</TableCell>
                                <TableCell align="right">{item.reffname}</TableCell>
